...
const SvgColors = ({ title, titleId, ...props }) => (
	...
	>
		...
		<path
			stroke="currentColor"
			d="M13.314 4.929 11.172 7.07c-.579.578-.867.867-1.02 1.234C10 8.673 10 9.082 10 9.9v9.657l8.97-8.97c.99-.99 1.486-1.486 1.671-2.056a2.5 2.5 0 0 0 0-1.545c-.185-.571-.68-1.066-1.67-2.056-.99-.99-1.486-1.485-2.056-1.67a2.5 2.5 0 0 0-1.545 0c-.571.185-1.066.68-2.056 1.67Z"
		/>
		<path
			stroke="currentColor"
