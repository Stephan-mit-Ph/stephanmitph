		...
		subsections: [
			{
				...
				city: 'Berlin/Remote',
				icons: [
					{ id: 30, name: 'Adobephotoshop', tooltip: 'Adobe Photoshop' },
		...
		subsections: [
			{
				...
				city: 'Köln/Remote',
				icons: [
					{ id: 42, name: 'Css3', tooltip: 'Css3' },
					{ id: 43, name: 'Github', tooltip: 'Github' },
					{ id: 44, name: 'Html5', tooltip: 'Html5' },
					{ id: 45, name: 'ITerm2', tooltip: 'iTerm2' },
					{ id: 46, name: 'Javascript', tooltip: 'Javascript' },
					{ id: 47, name: 'Jest', tooltip: 'Jest' },
					{ id: 48, name: 'MongoDB', tooltip: 'Mongo DB' },
					{ id: 49, name: 'Nextjs', tooltip: 'Next.js' },
					{ id: 50, name: 'Nodejs', tooltip: 'Node Js' },
					{ id: 51, name: 'React', tooltip: 'React' },
					{ id: 52, name: 'Prettier', tooltip: 'Prettier' },
					{ id: 53, name: 'Slack', tooltip: 'Slack' },
					{ id: 54, name: 'Styledcomponents', tooltip: 'Styled Components' },
					{ id: 55, name: 'Visualstudiocode', tooltip: 'Visual Studio Code' },
					{ id: 56, name: 'Zoom', tooltip: 'Zoom' },
				],
			},
			{
				id: 'internship',
				...
				city: 'Berlin/Remote',
				icons: [
					{ id: 57, name: 'Asana', tooltip: 'Asana' },
					{ id: 58, name: 'Canva', tooltip: 'Canva' },
					{ id: 59, name: 'Wordpress', tooltip: 'Wordpress' },
				],
			},
			{
				id: 'work-experience',
